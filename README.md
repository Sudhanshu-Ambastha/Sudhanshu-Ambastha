...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,py,java,react,tailwind,scss,vite,nextjs,vscode,anaconda,npm,nodejs,bootstrap,git,github,vercel,netlify)](https://skillicons.dev)
