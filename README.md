...
[![My Skills](https://go-skill-icons.vercel.app/api/icons?i=html,css,js,py,java,react,tailwind,scss,vite,nextjs,c,cpp,vscode,jupyter,googlecolab,anaconda,npm,nodejs,mongo,mysql,express,bootstrap,git,github,githubpages,vercel,netlify,render,streamlit,postman)](https://github.com/LelouchFR/skill-icons)
