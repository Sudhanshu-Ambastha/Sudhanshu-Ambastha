...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,py,java,react,redux,tailwind,vite,nextjs,vscode,anaconda,git,npm,nodejs,bootstrap,github,vercel,netlify)](https://skillicons.dev)
